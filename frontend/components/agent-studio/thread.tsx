    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        <ThreadPrimitive.Viewport
          turnAnchor="top"
          className="aui-thread-viewport relative flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden scroll-smooth px-4 pt-4"
        >
      ...
      <div className="flex shrink-0 flex-col gap-2 border-t border-border bg-background px-4 py-3 md:py-4">
    ...
    <div className="relative">
      <ThreadPrimitive.ScrollToBottom asChild>
        <TooltipIconButton
          ...
          variant="outline"
          className="aui-thread-scroll-to-bottom absolute -top-10 right-0 z-10 rounded-full disabled:invisible dark:border-border dark:bg-background dark:hover:bg-accent"
        >
